...
const KNOWLEDGE_TYPES = [
  {
    ...
    description: 'Protocolo estruturado de tratamento',
    icon: '📋',
  },
  {
    value: 'exercise',
    label: 'Exercício',
    description: 'Exercício terapêutico específico',
    icon: '🏃‍♂️',
  },
  {
    value: 'case',
    label: 'Caso Clínico',
    description: 'Caso real de paciente (anonimizado)',
    icon: '👤',
  },
  {
    value: 'technique',
    label: 'Técnica',
    description: 'Técnica manual ou procedimento',
    icon: '🤲',
  },
  {
    value: 'experience',
    label: 'Experiência',
    description: 'Conhecimento baseado em experiência prática',
    icon: '💡',
  },
];
...
const DIFFICULTY_LEVELS = [
  {
    value: 'beginner',
    label: 'Iniciante',
    description: 'Para estudantes e recém-formados',
  ...
  },
  {
    value: 'advanced',
    label: 'Avançado',
    description: 'Para especialistas e casos complexos',
...
const EVIDENCE_LEVELS = [
  {
    value: 'low',
    label: 'Baixo',
    description: 'Baseado em experiência clínica',
    color: 'bg-gray-100 text-gray-800',
  },
  {
    value: 'moderate',
    label: 'Moderado',
    description: 'Alguns estudos ou consensos',
    color: 'bg-blue-100 text-blue-800',
  },
  {
    value: 'high',
    label: 'Alto',
    description: 'Evidência científica robusta',
...
export const KnowledgeContribution: React.FC<KnowledgeContributionProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      aiLogger.error('KNOWLEDGE_CONTRIBUTION', 'Erro ao salvar contribuição', {
        error,
      });
    } finally {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-gray-600">
                Compartilhe seu conhecimento com a equipe
              </p>
            </div>
            ...
            <div className="prose max-w-none">
                ...
                <div className="mb-4 flex flex-wrap gap-2">
                  <span
                    className={`inline-block rounded-full px-3 py-1 text-sm font-medium ${
                      KNOWLEDGE_TYPES.find((t) => t.value === formData.type)
                        ?.value === 'protocol'
                        ? 'bg-blue-100 text-blue-800'
                        : KNOWLEDGE_TYPES.find((t) => t.value === formData.type)
                              ?.value === 'exercise'
                          ? 'bg-green-100 text-green-800'
                          : KNOWLEDGE_TYPES.find(
                  ...
                  <span
                    className={
                      EVIDENCE_LEVELS.find(
                        (e) => e.value === formData.evidenceLevel
                      )?.color +
                      ' inline-block rounded-full px-3 py-1 text-sm font-medium'
                    }
                  >
              ...
              {formData.contraindications.length > 0 && (
                <div className="mb-6">
                  ...
                  <ul className="list-inside list-disc space-y-1 rounded-lg bg-red-50 p-4 text-red-600">
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2">
                    {formData.references.map((reference, index) => (
                      <li
                        key={reference}
                        className="rounded bg-gray-50 p-3 text-sm text-gray-600"
                      >
              ...
              <div className="space-y-6">
                <div className="mb-6 text-center">
                  ...
                  <p className="text-gray-600">
                    Defina o tipo e conteúdo principal do conhecimento
                  </p>
                </div>
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setFormData((prev) => ({
                              ...prev,
                              type: e.target.value as KnowledgeEntry['type'],
                            }))
                          }
                          className="sr-only"
                        />
                ...
                <div>
                  ...
                  <div className="mt-2 flex justify-between text-sm text-gray-500">
                    ...
                    <span>
                      {Math.ceil(formData.content.length / 250)} min de leitura
                    </span>
                  </div>
                  {errors.content && (
            ...
            {step === 2 && (
              <div className="space-y-6">
                <div className="mb-6 text-center">
                  ...
                  <p className="text-gray-600">
                    Ajude outros profissionais a encontrar este conhecimento
                  </p>
                </div>
                    ...
                    <div className="space-y-2">
                      {DIFFICULTY_LEVELS.map((level) => (
                        ...
                        >
                          ...
                          <div>
                            <span
                              className={`mr-2 inline-block rounded-full px-2 py-1 text-xs font-medium ${level.color}`}
                            >
                              {level.label}
                            </span>
                        ...
                        >
                          <input
                            ...
                            onChange={(e) =>
                              setFormData((prev) => ({
                                ...prev,
                                evidenceLevel: e.target.value as any,
                              }))
                            }
                            className="mr-3 text-blue-600 focus:ring-blue-500"
                          />
            ...
            {step === 3 && (
              <div className="space-y-6">
                <div className="mb-6 text-center">
                  ...
                  <p className="text-gray-600">
                    Informações complementares para enriquecer o conhecimento
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="mb-3 flex gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        setCurrentContraindication(e.target.value)
                      }
                      onKeyPress={(e) =>
                        e.key === 'Enter' &&
                        (e.preventDefault(),
                    ...
                    {formData.contraindications.map((contraindication) => (
                      ...
                      >
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            removeItem(contraindication, 'contraindications')
                          }
